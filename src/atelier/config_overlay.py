...
SETTINGS_METADATA: dict[str, dict[str, Any]] = {
    ...
    "classify_seam_a_review_enabled": {
        "hocon_path": "classify.seam_a_review.enabled",
        "label": "Cautious-Code Review (Seam A)",
    ...
    "classify_seam_a_review_bel_threshold": {
        "hocon_path": "classify.seam_a_review.bel_threshold",
        "label": "Seam A Belief Threshold",
    ...
    "classify_seam_a_review_backend": {
        "hocon_path": "classify.seam_a_review.backend",
        "label": "Seam A Review Backend",
    ...
    "classify_bootstrap_sweep_deadline_s": {
        ...
        "description": "Wall-clock ceiling on the LLM sweep phase. 0 disables (default) — the consecutive-failure breaker already handles blackholed endpoints in ~2 min without needing a corpus-size guess.",
        "group": "convergence",
        "type": "float",
        "min": 0.0,
        "max": 21600.0,
        "step": 60.0,
        "default": 0.0,
        "caption_template": "{value}s ceiling (0 = disabled). Set a positive value only if you want a hard wall-clock wall on top of the consecutive-failure breaker.",
    },
