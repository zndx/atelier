...
SETTINGS_METADATA: dict[str, dict[str, Any]] = {
    ...
    "classify_discount_svm": {
        ...
        "step": 0.01,
        "default": 0.55,
        "caption_template": "Reserve {value_pct}% of SVM mass as ignorance — frontier SVM trains on LLM labels (non-distinct evidence per Denoeux 2008), so the principled default is high; lower only when retraining on labels that are independent of the LLM sweep.",
    },
