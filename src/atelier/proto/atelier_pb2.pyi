...
class ClassificationDataset(_message.Message):
    __slots__ = ("id", "name", "parquet_path", "description", "row_count", "source_id", "version_number", "is_active", "summary", "fsm_run_id", "created_at", "is_archived")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    created_at: str
    is_archived: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., parquet_path: _Optional[str] = ..., description: _Optional[str] = ..., row_count: _Optional[int] = ..., source_id: _Optional[str] = ..., version_number: _Optional[int] = ..., is_active: bool = ..., summary: _Optional[str] = ..., fsm_run_id: _Optional[str] = ..., created_at: _Optional[str] = ..., is_archived: bool = ...) -> None: ...

class ListDatasetsRequest(_message.Message):
    __slots__ = ("source_id", "include_archived")
    SOURCE_ID_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_ARCHIVED_FIELD_NUMBER: _ClassVar[int]
    source_id: str
    include_archived: bool
    def __init__(self, source_id: _Optional[str] = ..., include_archived: bool = ...) -> None: ...
