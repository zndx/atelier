...
GROUND_TRUTH="${GROUND_TRUTH:-build/data/ground_truth/ground_truth.json}"
...
# ── 3. Score against Ground Truth Complete ───────────────────────────
echo "[3/4] Score sweep outputs against Ground Truth Complete..."
