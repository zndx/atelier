...
Atelier is an agentic classification workbench for Cloudera AI. It combines the Claude Agent SDK for adaptive keystone-agent orchestration with an Embeddings Viewer for interactive visualization of classification results produced by the [signals](https://github.com/rch/signals) pipeline.
...
- **Embeddings Viewer** — Interactive parquet visualization of classification output (powered by [embedding-atlas](https://github.com/apple/embedding-atlas))
